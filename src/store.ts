...
import auth, { signOut } from '~src/modules/auth/auth.slice'
import user, { removeAll as userRemoveAll } from '~src/modules/user/user.slice'
import board, { removeAll as boardRemoveAll } from '~src/modules/board/board.slice'
...
export const signOutFn = (dispatch: AppDispatch) => {
  return Promise.all([
    dispatch(signOut()),
    dispatch(userRemoveAll()),
    dispatch(boardRemoveAll()),
    dispatch(boardApi.util.resetApiState()),
    dispatch(userApi.util.resetApiState()),
    dispatch(authApi.util.resetApiState()),
    // TODO: dispatch other APIs
  ])
}
